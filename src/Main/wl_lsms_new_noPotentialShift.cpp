    ...
    if (rank == 0) {
      ...
      switch (evecGenerationMode) {
        ...
        case WangLandau_2d:
          ...
          break;
        default:
          std::cerr << "REWL Main :: The code should never arrive here: "
                       "UNKNOWN EVEC GENERATION MODE\n";
          exit(1);
      }

      // Generate the initial configuration
      std::cout << "REWL Main :: starting main calculation in group "
                << my_group << std::endl;

...
void interpolatePotential(LSMSSystemParameters &lsms, AtomData &atom) {
  // Generate new radial mesh according to the new Muffin-Tin radius (inscribed
  // radius calculated in setupVorpol)

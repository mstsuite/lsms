...
subroutine green_function(mtasa, n_spin_pola, n_spin_cant, &
   ...
   !
   !     ================================================================
   !     re-calculate dos and green so that:
   !
   !     dos(1) = Tr[dos],           green(r,1) = Tr[green(r)]
   !                 ---                             -----
   !
   !     dos(2) = Tr[dos*wx],        green(r,2) = Tr[green(r)*wx]
   !                 --- --                          -----    --
   !
   !     dos(3) = Tr[dos*wy],        green(r,3) = Tr[green(r)*wy]
   !                 --- --                          -----    --
   !
   !     dos(4) = Tr[dos*wz],        green(r,4) = Tr[green(r)*wz]
   !                 --- --                          -----    --
   !
   !     ================================================================

...
void tau_inv_postproc_nrel_(int *kkrs_ns, int *n_spin_cant, Complex *wbig,
                            Complex *delta, Complex *tmat, int *ipvt,
                            Complex *tau00, Complex *ubr, Complex *ubrd,
                            Complex *tau00_tmp);

void tau_inv_postproc_rel_(int *kkrs_ns, Complex *wbig, Complex *delta,
                           Complex *tmat, int *ipvt, Complex *tau00,
                           Complex *dmatp, Complex *dmat, Complex *tau00_tmp);
}
#endif

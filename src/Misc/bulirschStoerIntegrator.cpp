...
void dfv_m_(double *r, double *y, double *dy, int *nv, int *n, double *rn,
            ...
            double *allp1);
void bulirsch_stoer_integrator_(double *xFrom, double *xTo, double *y,
                                double *dy, int *nv, double *rn,
                                std::complex<double> *ecomp, double *vr,
...
// of the radial ODE
inline void modifiedMidpoint_dfv(double x0, double x1, double *y0, double *y1,
                                 int n, int steps, int *nv, int *nextrp,
                                 double *rn, std::complex<double> *ecomp,
                                 double *vr, double *eunit, double *b,
                                 double *allp1) {
  double y2[n], dy[n];
...
inline int bulirschStoerIntegrator_dfv(double x0, double x1, double *y0,
                                       double *y1, int n, int *nv, int *nextrp,
                                       double *rn, std::complex<double> *ecomp,
                                       double *vr, double *eunit, double *b,
                                       double *allp1, double eps = 1.0e-12) {
  const int nSteps = 11;
...
void bulirsch_stoer_integrator_(double *xFrom, double *xTo, double *y,
  ...
  //                                  [&nv,&rn,&ecomp,&vr,&eunit,&b,&allp1,&nextrp](double
  //                                  x, double *y, double *dy)
  //                                  {
